    ...
    <nav>
        <v-app-bar app color="#2596be">
            ...
            <v-app-bar-title class="text-uppercase">
                ...
                <span class="white--text">Books</span>
            </v-app-bar-title>

            <v-spacer></v-spacer>

            <span class="font-weight-light white--text ">Welcome,</span>
            <span class="white--text mr-6">member</span>
    ...
    data(){
        return {
            ...
            items: [
                ...
                active: false,
                items: [
                    { title: 'Lihat Daftar Buku', icon: 'mdi-eye', route: '/listbuku'},
                ...
                active: false,
                items: [
                    { title: 'Buku pinjam', icon: 'mdi-playlist-check', route: '/listBookMember'},
                    { title: 'Buku Kembali', icon: 'mdi-account-plus', route: '/listReturnMember'},
                ],
